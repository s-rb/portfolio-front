...
export const ExperienceData = [
    {
        period: "12.2023 - now",
        company: Companies.AlfaBank,
        position: "Lead software engineer",
        description: "- Developed various solutions for a project managing biometric data of clients and employees: collection, storage, processing, and integration with other Bank systems and government agencies.\n" +
        ...
        description: "- I developed banking software for one of the largest banks in the country. This included " +
            ...
            "of issued loans.\n" +
            "- I also redirected loan applications from another lending direction, which resulted in an " +
            "additional flow of loan applications.\n" +
            "- Performed several technical improvements that significantly reduced " +
        ...
        description: "- I took part in maintaining the company's main product, banking software, for various banks " +
            "worldwide. Modernized it by migrating logic from database procedures to Java microservices.\n" +
            "- Developed a service for receiving multicast data from the stock exchange, in a multithreading mode from multiple " +
        ...
        description: "- Developed the backend for a sports federation portal and an application for working with the " +
            "database of a government electoral system.\n" +
            "- Implemented full-text search (by vectors) in the PostgreSQL database.\n" +
            "- Created an approximate search by multiple parameters using the similarity function based on " +
            "trigrams in the database, with the ability to set arbitrary search accuracy. This simplified data entry " +
            "by operators about users, user search, and error correction in a large amount of personal data.\n" +
            "- Additionally, I developed a functionality for mass creation of data records about clients based on uploaded data in text " +
